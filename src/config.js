// ============================================
// EASY EDIT CONFIG - Ubah data di sini
// ============================================

export const CONFIG = {
  // Nama penerima dan pengirim
  recipientName: "Rifka Wang",
  ...
  closeDate: "2026-05-29T00:03:00+07:00",
  ...
  // Firebase config
  firebaseConfig: {
    apiKey: "AIzaSyBYvriMajuBcnB-SdTe0wlq5PhIcVbJ3dw",
    authDomain: "rifka-birthday.firebaseapp.com",
    projectId: "rifka-birthday",
    storageBucket: "rifka-birthday.firebasestorage.app",
    messagingSenderId: "386231760104",
    appId: "1:386231760104:web:fa6dc77a35fe0f075c855d",
  },
  ...
  photos: [
    ...
    },
    {
      ...
      caption: "Always my favorite memory 💕",
    },
  ],

  video: {
    src: "/assets/video1.mp4",
    caption: "A little moment, forever remembered.",
  },
...
"Happy birthday once again, Rifka. Take care always.",
  ...
  memoriesText: {
    ...
    subtitle: "Some moments don't need to be perfect to be unforgettable.",
    quote:
      "Every photo has a story. Every video holds a feeling. And every memory we made — no matter how small — means everything to me.",
    closing: "Thank you for being part of my story. 💕",
  },
};
